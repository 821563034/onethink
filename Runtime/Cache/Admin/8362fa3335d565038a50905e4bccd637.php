...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>任务设置</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">部门<span class="check-tips">（用于左侧分组二级菜单）</span></label>
            <div class="controls">
                <select name="dept">
        ...
        <div class="form-item">
            <label class="item-label">任务类型名称<span class="check-tips">（用于后台显示的配置任务类型）</span></label>
            <div class="controls">
