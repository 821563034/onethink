...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="nickname" class="search-input" value="<?php echo I('name');?>" placeholder="请输入用户昵称或者ID">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Task/taskType?id='.$vo['id']);?>"><?php echo ($vo["name"]); ?></a></td>
			<td><?php echo ($vo["pid"]); ?></td>
			<td><?php echo ($vo["sort"]); ?></td>
			<td>
				<a href="<?php echo U('Task/edit?id='.$vo['id']);?>">编辑</a>
				<a href="<?php echo U('Task/remove?id='.$vo['id']);?>" class="ajax-get">删除</a>
				<a href="<?php echo U('Task/editConfig?id='.$vo['id']);?>">编辑配置</a>
                </td>
