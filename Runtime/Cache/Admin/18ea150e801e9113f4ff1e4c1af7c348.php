...
<body>
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>部门</h2>
	</div>
	<div class="tab-wrap">
		<ul class="tab-nav nav">
			<li data-tab="tab1" class="current"><a href="javascript:void(0);">部门信息</a></li>
		</ul>
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					<div class="form-item">
						<label class="item-label">上级部门<span class="check-tips"></span></label>
						<div class="controls">
							<input type="text" class="text input-large" disabled="disabled" value="<?php echo ((isset($dept['name']) && ($dept['name'] !== ""))?($dept['name']):'无'); ?>"/>
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">
							部门名称<span class="check-tips">（部门不能为空）</span>
						</label>
						<div class="controls">
					...
					<div class="form-item">
						<label class="item-label">
							部门标识<span class="check-tips">（英文字母）</span>
						</label>
						<div class="controls">
							<input type="text" name="desc" class="text input-large" value="<?php echo ((isset($info["desc"]) && ($info["desc"] !== ""))?($info["desc"]):''); ?>">
						</div>
					</div>
					<div class="form-item">
				...
				<div class="form-item">
					...
					<input type="hidden" name="pid" value="<?php echo isset($dept['id'])?$dept['id']:$info['pid'];?>">
	...
	<script type="text/javascript">
		...
		//导航高亮
		highlight_subnav('<?php echo U('Dept/index');?>');
	</script>
