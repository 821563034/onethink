...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('add');?>">发布任务</a>
        </div>

        <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="no" class="search-input" value="<?php echo I('no');?>" placeholder="请输入任务名称">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["start_position"]); ?></td>
			<td><?php echo ($vo["end_position"]); ?></td>
			<td><?php echo ($vo["scheduled"]); ?></td>
			<td>
				<a href="<?php echo U('TaskManage/edit?id='.$vo['id']);?>">编辑</a>
				<a href="<?php echo U('TaskManage/remove?id='.$vo['id']);?>" class="ajax-get">删除</a>
			</td>
